...
(defpackage #:sdl2
  ...
  (:export
   ...
   #:+allow-alt-tab-while-grabbed+
   #:+allow-top-most+
   #:+android-apk-expansion-main-file-version+
   #:+android-apk-expansion-patch-file-version+
   #:+android-block-on-pause+
   #:+android-block-on-pause-pause-audio+
   #:+android-trap-back-button+
   #:+app-name+
   #:+apple-tv-controller-ui-events+
   #:+apple-tv-remote-allow-rotation+
   #:+audio-category+
   #:+audio-device-app-name+
   #:+audio-device-stream-name+
   #:+audio-device-stream-role+
   #:+audio-include-monitors+
   #:+audio-resampling-mode+
   #:+auto-update-joysticks+
   #:+auto-update-sensors+
   #:+bmp-save-legacy-format+
   #:+display-usable-bounds+
   #:+emscripten-asyncify+
   #:+emscripten-keyboard-element+
   #:+enable-steam-controllers+
   #:+event-logging+
   #:+framebuffer-acceleration+
   #:+gamecontroller-config+
   #:+gamecontroller-config-file+
   #:+gamecontroller-type+
   #:+gamecontroller-ignore-devices+
   #:+gamecontroller-ignore-devices-except+
   #:+gamecontroller-use-button-labels+
   #:+grab-keyboard+
   #:+idle-timer-disabled+
   #:+ime-internal-editing+
   #:+ime-show-ui+
   #:+ios-hide-home-indicator+
   #:+joystick-allow-background-events+
   #:+joystick-device+
   #:+joystick-hidapi+
   #:+joystick-hidapi-gamecube+
   #:+joystick-hidapi-joy-cons+
   #:+joystick-hidapi-luna+
   #:+joystick-hidapi-ps4+
   #:+joystick-hidapi-ps4-rumble+
   #:+joystick-hidapi-ps5+
   #:+joystick-hidapi-ps5-rumble+
   #:+joystick-hidapi-stadia+
   #:+joystick-hidapi-steam+
   #:+joystick-hidapi-switch+
   #:+joystick-hidapi-switch-home-led+
   #:+joystick-hidapi-xbox+
   #:+joystick-raw-input+
   #:+joystick-raw-input-correlate-xinput+
   #:+joystick-thread+
   #:+kmsdrm-require-drm-master+
   #:+linux-joystick-classic+
   #:+linux-joystick-deadzones+
   #:+mac-background-app+
   #:+mac-ctrl-click-emulate-right-click+
   #:+mouse-double-click-radius+
   #:+mouse-double-click-time+
   #:+mouse-focus-click-through+
   #:+mouse-normal-speed-scale+
   #:+mouse-relative-mode-warp+
   #:+mouse-relative-scaling+
   #:+mouse-relative-speed-scale+
   #:+mouse-touch-events+
   #:+no-signal-handlers+
   #:+opengl-es-driver+
   #:+orientations+
   #:+poll-sentinel+
   #:+qtwayland-context-orientation+
   #:+qtwayland-window-flags+
   #:+render-batching+
   #:+render-line-method+
   #:+render-direct3d11-debug+
   #:+render-direct3d-threadsafe+
   #:+render-driver+
   #:+render-logical-size-mode+
   #:+render-opengl-shaders+
   #:+render-scale-quality+
   #:+render-vsync+
   #:+return-key-hides-ime+
   #:+rpi-video-layer+
   #:+screensaver-inhibit-activity-name+
   #:+thread-force-realtime-time-critical+
   #:+thread-priority-policy+
   #:+thread-stack-size+
   #:+timer-resolution+
   #:+touch-mouse-events+
   #:+tv-remote-as-joystick+
   #:+video-allow-screensaver+
   #:+video-double-buffer+
   #:+video-egl-allow-transparency+
   #:+video-external-context+
   #:+video-highdpi-disabled+
   #:+video-mac-fullscreen-spaces+
   #:+video-minimize-on-focus-loss+
   #:+video-wayland-allow-libdecor+
   #:+video-window-share-pixel-format+
   #:+video-win-d3dcompiler+
   #:+video-x11-net-wm-bypass-compositor+
   #:+video-x11-net-wm-png+
   #:+video-x11-window-visualid+
   #:+video-x11-xinerama+
   #:+video-x11-xrandr+
   #:+wave-fact-chunk+
   #:+wave-riff-chunk-size+
   #:+wave-truncation+
   #:+windows-disable-thread-naming+
   #:+windows-force-mutex-critical-sections+
   #:+windows-force-semaphore-kernel+
   #:+windows-int-resource-icon+
   #:+windows-int-resource-icon-small+
   #:+windows-no-close-on-alt-f4+
   #:+windows-use-d3d9ex+
   #:+window-frame-usable-while-cursor-hidden+
   #:+window-no-activation-when-shown+
   #:+winrt-handle-back-button+
   #:+winrt-privacy-policy-label+
   #:+winrt-privacy-policy-url+
   #:+x11-force-override-redirect+
   #:+xinput-enabled+
   #:+xinput-use-old-joystick-mapping+
   #:get-hint
   #:set-hint
